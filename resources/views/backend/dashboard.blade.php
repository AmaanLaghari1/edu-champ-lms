                                ...
                                <ul>
                                    <li>
                                        <span class="new-users-pic">
                                            <img src="{{asset('admin')}}/assets/images/testimonials/pic1.jpg" alt=""/>
                                        </span>
                                    ...
                                    <li>
                                        <span class="new-users-pic">
                                            <img src="{{asset('admin')}}/assets/images/testimonials/pic2.jpg" alt=""/>
                                        </span>
                                        <span class="new-users-text">
                                    ...
                                    <li>
                                        <span class="new-users-pic">
                                            <img src="{{asset('admin')}}/assets/images/testimonials/pic3.jpg" alt=""/>
                                        </span>
                                        <span class="new-users-text">
